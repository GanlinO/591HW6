...
The class DynamicSolution is very similar to the provided class Solution, and it creates a new word family every time a new guess is received by an EvilHangman object, determines if a partial solution needs to be updated, and prints messages reporting progress or victory.

To run the program, just execute the EvilHangmanRunner class.